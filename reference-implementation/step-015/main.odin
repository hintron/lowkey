...
main :: proc() {
	...
	for {
		...
		execute(ast_nodes, tokens, input_string, &state, arena_allocator)
	}
}
...
// Execute the AST
execute :: proc(ast_nodes: [dynamic]AstNode, tokens: [dynamic]Token, source_text: string, state: ^InterpreterState, allocator: runtime.Allocator) {
